            ...
            <el-table-column
                ...
                <template scope='scope'>
                    ...
                    <el-button
                            ...
                            icon='edit'
                            size="mini"
                            @click='onEditClub(scope.row)'></el-button>

                    <!--<el-button-->
                            <!--type="primary"-->
                            <!--size="mini"-->
                            <!--@click='onSetAccess(scope.row,scope.$index,club_list)'>设置权限-->
                    <!--</el-button>-->
                    ...
                    <el-button
                            ...
                            icon='delete'
                            size="mini"
                            @click='onDeleteClub(scope.row,scope.$index,club_list)'></el-button>


                    <!--&lt;!&ndash; 不要试图强制打开这个操作，因为服务端做了验证，打开也没用n(*≧▽≦*)n &ndash;&gt;-->
                    <!--<el-button-->
                            <!--size="mini"-->
                            <!--:type="scope.row.status==1 ? 'danger' : 'info'"-->
                            <!--@click='onSetStatusUser(scope.row,scope.$index,club_list)'>{{scope.row.status==1 ? '禁用' :-->
                        <!--'启用'}}-->
                    <!--</el-button>-->
                </template>
            </el-table-column>
